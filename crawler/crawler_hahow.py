...
def crawl_hahow():
    ...
    url = "https://api.hahow.in/api/products/search?category=COURSE&limit=24&page=0&query={}&sort=RELEVANCE".format(
        keyword
    )
                ...
                try:
                    new_course = {
                        ...
                        "rating": (
                            ...
                            if "averageRating" in course
                            else None
                        ),
                        "student": (
                            course["numSoldTickets"]
                            if "numSoldTickets" in course
                            else None
                        ),
                    }
